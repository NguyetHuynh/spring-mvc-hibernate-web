	...
	<section id="page" class="container-fluid main-page">
		<div class="col-sm-12 col-md-3 left-sidebar">
			<div class="login sidebar-content">
				...
				<a href="LoginForm.html">Login to MyGseT Portal</a>
			...
			<div class="sidebar-content">
				...
				<a href="#">News 1</a>
				<a href="#">News 2</a>
				<div class="more"><a href="ListENews.html">More...</a></div>
				<hr>
				<a href="SubscribeForm.html">Subscribe e-News</a>
				<a href="#">Unsubscribe e-News</a>
			</div>
		</div><!-- /.left-sidebar -->
		...
		<div class="col-sm-12 col-md-6 page-content">
			<h3>${delDone}</h3>
			<form class="myForm" role="form" action="unsubscribe.html" method="post">
				<h2>MyGSet e-News Unsubscription</h2>
				<p>If you wish to stop receiving news alert to your e-mail please folloe the following to unsubscribe our e-News </p>
				<p><span style="color:#ff8040; font-weight:bold">To Unsubscribe</span></p>
			  	<div class="form-group">
				    <label for="email">Email address:</label>
				    <input type="email"  id="email" class="form-control" name="subEmail" 
				    placeholder="example@gmail.com" required><br>
			  	</div>
			  	<button type="submit" class="btn btn-warning gstBtn">Submit</button>
			</form>	
		</div><!-- /.page-content -->
		...
		<div class="col-sm-12 col-md-3 right-sidebar">
			...
			<div class="sidebar-content">
				...
				<form class="formPoll" action="ePoll.jsp" >
					<h5>How you rate this portal?</h5>
